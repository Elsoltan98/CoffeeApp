import robustaSquare from '../assets/coffee_assets/robusta_coffee_beans/robusta_coffee_beans_square.png';
import robustaPortrait from '../assets/coffee_assets/robusta_coffee_beans/robusta_coffee_beans_portrait.png';
import arabicaSquare from '../assets/coffee_assets/arabica_coffee_beans/arabica_coffee_beans_square.png';
import arabicaPortrait from '../assets/coffee_assets/arabica_coffee_beans/arabica_coffee_beans_portrait.png';
import libericaSquare from '../assets/coffee_assets/liberica_coffee_beans/liberica_coffee_beans_square.png';
...
const BeansData = [
  {
    ...
    imagelink_square: robustaSquare,
    imagelink_portrait: robustaPortrait,
    ingredients: 'Africa',
  ...
  },
  {
    ...
    roasted: 'Medium Roasted',
    imagelink_square: arabicaSquare,
    imagelink_portrait: arabicaPortrait,
    ingredients: 'Africa',
    special_ingredient: 'From Africa',
    prices: [
      {size: '250gm', price: '5.50', currency: '$'},
  ...
  },
  {
    ...
    roasted: 'Medium Roasted',
    imagelink_square: libericaSquare,
    imagelink_portrait: libericaPortrait,
  ...
  },
  {
    ...
    roasted: 'Medium Roasted',
    imagelink_square: excelsaSquare,
    imagelink_portrait: excelsaPortrait,
    ingredients: 'Malaysia',
    special_ingredient: 'From Malaysia',
    prices: [
      {size: '250gm', price: '5.50', currency: '$'},
